...
We intend on building and displaying versatile reusable web components and building out little apps with them.

In this project, we design a framework in which we can display and use the web components we are building and using in our projects that will also be found in this framework.